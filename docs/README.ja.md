...
Windows は macOS と同じ v3.0.5 です。[最新リリース](https://github.com/itzhaolei/codex-usage-widget/releases/latest)から `QuotaBubble-*-Windows-Setup.exe` をダウンロードし、ダブルクリックして GUI インストーラーを実行してください。PowerShell、Node.js、ターミナル、別途の .NET ランタイムは不要です。
