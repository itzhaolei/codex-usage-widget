...
[Quota Bubble 公式サイト](https://htmlpreview.github.io/?https://github.com/itzhaolei/codex-usage-widget/blob/main/public/index.html?v=20260718-1)のメインボタンをクリックしてください。macOS / Windows を自動判定し、Release ページを経由せず最新の GUI インストーラーを直接ダウンロードします。
