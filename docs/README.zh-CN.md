...
Windows 已与 macOS 对齐到 v3.0.2，请从 [v3.0.2 发布页](https://github.com/itzhaolei/codex-usage-widget/releases/tag/v3.0.2) 下载 `QuotaBubble-*-Windows.zip`，解压后运行 `windows/install.ps1`。
