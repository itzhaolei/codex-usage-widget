...
Windows 已与 macOS 对齐到 v3.0.5。请从[最新版本发布页](https://github.com/itzhaolei/codex-usage-widget/releases/latest)下载 `QuotaBubble-*-Windows-Setup.exe`，双击后按照图形安装向导操作。用户不需要 PowerShell、Node.js、命令行或额外安装 .NET 运行时；更新和卸载也通过图形界面完成。
