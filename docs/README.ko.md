...
- 닫기 버튼은 창만 숨기며 메뉴 막대 또는 시스템 트레이의 할당량 업데이트는 계속됩니다. 종료는 앱 또는 트레이 메뉴에서 실행합니다.
...
- 앱 메뉴 또는 `Command-N`으로 동기화된 창을 여러 개 열 수 있습니다. 모든 창은 동일한 실시간 할당량을 공유하며 위치는 개별 저장됩니다.
