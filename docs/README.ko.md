...
Windows는 macOS와 동일한 v3.0.2입니다. [v3.0.2 릴리스](https://github.com/itzhaolei/codex-usage-widget/releases/tag/v3.0.2)에서 `QuotaBubble-*-Windows.zip`을 다운로드하고 압축을 푼 뒤 `windows/install.ps1`을 실행하세요.
