...
Windows는 macOS와 동일한 v3.0.4입니다. [최신 릴리스](https://github.com/itzhaolei/codex-usage-widget/releases/latest)에서 `QuotaBubble-*-Windows-Setup.exe`를 다운로드하고 그래픽 설치 프로그램을 더블클릭하세요. PowerShell, Node.js, 터미널 또는 별도 .NET 런타임이 필요하지 않습니다.
