...
Windows è allineato a macOS nella v3.0.5. Scarica `QuotaBubble-*-Windows-Setup.exe` dall’[ultima release](https://github.com/itzhaolei/codex-usage-widget/releases/latest) e apri con doppio clic l’installer grafico. Non servono PowerShell, Node.js, terminale o un runtime .NET separato.
