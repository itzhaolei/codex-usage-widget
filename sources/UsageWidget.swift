...
class WindowController: NSWindowController, NSWindowDelegate {
    ...
    convenience init() {
        ...
        balanceCardView = MetricCardView(frame: NSRect(x: 12, y: 93, width: 131, height: 47))
        balanceCardView.autoresizingMask = [.maxXMargin, .maxYMargin]
        rootView.addSubview(balanceCardView)

        resetCardView = MetricCardView(frame: NSRect(x: 153, y: 93, width: 131, height: 47))
        ...
        accountIconView = NSImageView(frame: NSRect(x: 12, y: 67, width: 13, height: 13))
        ...
        accountValueLabel.frame = NSRect(x: 31, y: 64, width: 205, height: 17)
        ...
        subscriptionIconView = NSImageView(frame: NSRect(x: 12, y: 49, width: 13, height: 13))
        ...
        subscriptionValueLabel.frame = NSRect(x: 31, y: 46, width: 205, height: 17)
